...
app.configure(function() {
	app.set('port', process.env.OPENSHIFT_NODEJS_PORT || 3000);						// THIS PORT CAN BE CHANGED
  	app.set('ipaddr', process.env.OPENSHIFT_NODEJS_IP || "127.0.0.1");				// CHANGE THIS URL TO SERVER URL
